...
std::string SQLiteStatement::GetColumnString(int column) const
{
	CheckStatement();
	std::stringstream ss;
	ss << sqlite3_column_text(mStatement, column);
	return ss.str();
}
...
{
	return GetColumnValue(sql, &Kompex::SQLiteStatement::GetColumnCString, defaultReturnValue);
}
...
{
	return GetColumnValue(sql, &Kompex::SQLiteStatement::GetColumnString16, defaultReturnValue);
}
...
{
	return GetColumnValue(sql, &Kompex::SQLiteStatement::GetColumnBlob, defaultReturnValue);
}
