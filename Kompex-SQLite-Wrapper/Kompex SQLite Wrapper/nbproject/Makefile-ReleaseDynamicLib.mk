...
.build-conf: ${BUILD_SUBPROJECTS}
	${MAKE}  -f nbproject/Makefile-ReleaseDynamicLib.mk ../lib/release/KompexSQLiteWrapper.so
...
${OBJECTDIR}/_ext/_DOTDOT/src/KompexSQLiteStatement.o: nbproject/Makefile-${CND_CONF}.mk ../src/KompexSQLiteStatement.cpp 
	...
	${RM} $@.d
	$(COMPILE.cc) -O2 -DKOMPEX_SQLITEWRAPPER_EXPORT -DKOMPEX_SQLITEWRAPPER_DYN -I../inc -fPIC  -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/_DOTDOT/src/KompexSQLiteStatement.o ../src/KompexSQLiteStatement.cpp

${OBJECTDIR}/_ext/_DOTDOT/src/KompexSQLiteDatabase.o: nbproject/Makefile-${CND_CONF}.mk ../src/KompexSQLiteDatabase.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/_DOTDOT/src
	${RM} $@.d
	$(COMPILE.cc) -O2 -DKOMPEX_SQLITEWRAPPER_EXPORT -DKOMPEX_SQLITEWRAPPER_DYN -I../inc -fPIC  -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/_DOTDOT/src/KompexSQLiteDatabase.o ../src/KompexSQLiteDatabase.cpp

${OBJECTDIR}/_ext/_DOTDOT/src/sqlite3.o: nbproject/Makefile-${CND_CONF}.mk ../src/sqlite3.c 
	${MKDIR} -p ${OBJECTDIR}/_ext/_DOTDOT/src
	${RM} $@.d
	$(COMPILE.c) -O2 -fPIC  -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/_DOTDOT/src/sqlite3.o ../src/sqlite3.c
